module github.com/SneaksAndData/nexus-receiver

go 1.23.1

require (
	github.com/SneaksAndData/nexus-core v0.3.1-0.20250310144313-dcbdb0723df1
...
require (
	...
	github.com/samber/slog-datadog/v2 v2.8.2 // indirect
